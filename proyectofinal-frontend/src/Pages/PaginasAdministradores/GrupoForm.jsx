          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <div>
              ...
              <p style={{ margin: '0.25rem 0 0', color: 'var(--color-text-secondary)', fontSize: '0.9rem' }}>
                {isEditing ? 'Modifica la información del grupo' : 'Configura los detalles del nuevo grupo'}
              </p>
            </div>
          </div>
                ...
                <div style={{
                  ...
                  <form onSubmit={submit}>
                    ...
                    <div>
                      ...
                      <input 
                        value={userData ? (userData.nombre || userData.name || userData.usuario || 'Administrador') : 'Administrador'} 
                        readOnly 
                        style={{
                          width: '100%',
                          padding: '0.75rem 1rem',
